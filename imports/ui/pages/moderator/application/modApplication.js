...
Template.modApplication.helpers({
    ...
    showLine: function() {
        return (Template.instance().reply.get(this.question.key) || {})[this._id] || (Template.instance().show.get(this.question.key) || {})[this._id]
    },
    ...
    isDelegated: function() {
        ...
        return delegates && (~delegates.scope.indexOf('all') || ~delegates.scope.indexOf(this._id)) && (!~(delegates.except || []).indexOf(this._id)) // filter out all delegations not connected to this application
    },
    ...
    delegateIntent: function() {
        return (Template.instance().delegates.get(this.question.key) || {})[this._id]
    },
    ...
    eloRank: function() {
        return (EloRankings.findOne({
            questionId: this.question.key,
            applicationId: this._id
        }) || {}).ranking || 400 // 400 is the default value
    },
    hasNext: function() {
...
Template.modApplication.events({
    ...
    'click .new-comment': function(event, templateInstance) {
        ...
        newComment.call({
            ...
            if (!err) {
                ...
                templateInstance.reply.set(this.question.key, _.extend(templateInstance.reply.get(this.question.key) || {}, {
                    [this._id]: false
                }))

                templateInstance.message.set(this.question.key, _.extend(templateInstance.reply.get(this.question.key) || {}, {
                    [this._id]: ''
                }))
                templateInstance.show.set(this.question.key, _.extend(templateInstance.show.get(this.question.key) || {}, {
                    [this._id]: true
                }))
            } else {
                templateInstance.message.set(this.question.key, _.extend(templateInstance.message.get(this.question.key) || {}, {
    ...
    'click .comment-show': function(event, templateInstance) {
        ...
        templateInstance.show.set(this.question.key, _.extend(templateInstance.reply.get(this.question.key) || {}, {
            [this._id]: !(templateInstance.show.get(this.question.key) || {})[this._id]
        }))
    },
    ...
    'click .js-delegate': function(event, templateInstance) {
        ...
        templateInstance.delegates.set(this.question.key, _.extend(templateInstance.reply.get(this.question.key) || {}, {
            [this._id]: !(templateInstance.delegates.get(this.question.key) || {})[this._id]
        }))
